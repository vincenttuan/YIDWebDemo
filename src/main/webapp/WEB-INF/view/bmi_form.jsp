        ...
        <form class="pure-form" method="post" action="/YIDWebDemo/servlet/bmi">
            <fieldset>
                <legend>計算 BMI</legend>
                    姓名：<input type="text" id="myname" name="myname" value="john" /><p>
                    身高：<input type="number" id="myheight" name="myheight" value="170" /><p>
                    體重：<input type="number" id="myweight" name="myweight" value="60" /><p>
